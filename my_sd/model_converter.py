...
def load_from_standard_weights(input_file: str, device: str) -> dict[str, torch.Tensor]:
    ...
    original_model = torch.load(input_file,  weights_only = False, map_location='cpu')["state_dict"]
    # original_model = {key: value.half() for key, value in original_model.items()}
